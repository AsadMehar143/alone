...
\033[0;94m  ⚡ ✯ 𝕮𝖗𝖊𝖆𝖙𝖔𝖗 ✪ 𝔐ℜ.𝔖ℌ𝔄𝔉𝔔𝔄𝔗   ✬⚡

\033[0;94m  ⚡ ✯ 𝖄𝖔𝖚𝖙𝖚𝖇𝖊 ✪ Zenix Creations ✬⚡
...
jalan("\033[1;96m•◈•────────────•◈•\033[1;99mAlone\033[1;99m•◈•────────────•◈•")                        
...
jalan("\033[1;93m Welcome to Zenix Creations")

jalan("\033[1;96m•◈•──────────•◈•\033[1;96mPakTigers\033[1;96m•◈•──────────•◈•")

CorrectUsername = "alone"
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
	    ...
	    time.sleep(2)
            ...
            os.system('xdg-open https://m.youtube.com/channel/UCCuHu4bK8j0ULnTzDPLYgLg')
	...
	try:
		...
		if 'save-device' in url:
			...
			try:
				...
				os.system('xdg-open https://www.youtube.com/channel/UCCuHu4bK8j0ULnTzDPLYgLg')
...
def menu():
	...
	print "\033[1;32;40m[2] \033[1;33;42mUpdate Alone"																														
